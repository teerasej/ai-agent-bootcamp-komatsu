...
// TODO: Add the expense.budgetType rule to the REQUIRED FIELDS section
// TODO: Add "budgetType": "Expense | Investment" to the OUTPUT FORMAT expense block
string pvAgentInstructions = """
    ...
    [TODO: add expense.budgetType rule here]
    ...
    OUTPUT FORMAT (produce this JSON when all fields are collected and confirmed):
    {
      "pv": {
        ...
        "expense": {
          ...
          [TODO: add budgetType field here]
