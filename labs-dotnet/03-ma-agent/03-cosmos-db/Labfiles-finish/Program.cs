...
// GetPvRequests tool — queries all documents from Cosmos DB and filters by approval status
...
// UpdatePvApprovalStatus tool — reads a PV document, updates approval.status, replaces it
